...
def login_device_flow(*, open_browser: bool = True, scopes: str | None = None) -> str:
    ...
    try:
        token_resp = run_device_flow(client_id, scope=scope, open_browser=open_browser)
...
def ensure_valid_token(
    *,
    ...
    if force_login:
        delete_token()
        token = login_device_flow(open_browser=open_browser, scopes=scopes)
