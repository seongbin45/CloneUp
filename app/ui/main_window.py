    ...
    def _install_tab_tip_cards(self) -> None:
        ...
        tips: list[tuple[str, str, str]] = [
            (
                ...
                "이 PC 폴더를 GitHub에 처음 올리는 탭입니다.",
                "한 줄로: 내 컴퓨터에 있는 폴더를 GitHub에도 새로 만들고 맞춥니다.\n"
                "\n"
                "① 위쪽 「GitHub: 연결」에서 키를 붙여 넣습니다.\n"
                "   (만들고 올리기에는 classic 키 + 저장소(repo) 권한이 필요합니다.)\n"
                "② 올릴 폴더를 고릅니다.\n"
                "③ 저장소 이름·공개/비공개를 정합니다.\n"
                "   · 공개 = 링크 있으면 다른 사람도 볼 수 있습니다.\n"
                "   · 비공개 = 나와 허용된 사람만 봅니다.\n"
                "④ 「커밋에 내 이메일 숨기기」를 켜 두면 학교·회사 메일이 안 남습니다.\n"
                "⑤ 「GitHub에 만들고 올리기」를 누릅니다.\n"
                "\n"
                "알아 두기\n"
                "· branch(줄기 이름) 기본값은 main 입니다. 바꿀 이유가 없으면 main이면 됩니다.\n"
                "· .env 같은 비밀 파일은 기본으로 올리지 않습니다.\n"
                "· 더 자세한 말은 설정 → 용어 안내에서 볼 수 있습니다.",
            ),
            (
                "labelTabIntroClone",
                "GitHub 저장소를 이 PC로 가져오는 탭입니다.",
                "한 줄로: GitHub에 이미 있는 프로젝트를 내 컴퓨터 폴더로 받습니다.\n"
                "\n"
                "① GitHub 주소를 붙여 넣거나, 연결 후 「목록 ▼」에서 고릅니다.\n"
                "② 어디에 받을지(부모 폴더)·폴더 이름을 정합니다.\n"
                "③ 「받기」를 누릅니다.\n"
                "\n"
                "알아 두기\n"
                "· 같은 이름 폴더가 이미 있으면 실패합니다. 이름을 바꾸세요.\n"
                "· 비공개 저장소는 위쪽 「GitHub: 연결」이 필요합니다.\n"
                "· 「커밋 내역」으로 그 주소의 지난 기록을 볼 수 있습니다.\n"
                "  공개 저장소는 연결 없이도 볼 수 있습니다.\n"
                "· 받은 뒤에는 「동기화」 탭에서 더 고치고 맞춥니다.",
            ),
            (
                "labelTabIntroSync",
                "이미 이어 둔 폴더와 GitHub를 맞추는 탭입니다.",
                "한 줄로: 이 PC에서 고친 것과 GitHub에 있는 것을 맞춰 갑니다.\n"
                "\n"
                "① 폴더를 고릅니다. (.git 이 있어야 합니다.)\n"
                "   없으면 「받기」또는 「만들고 올리기」를 먼저 하세요.\n"
                "② 「받아오기」— GitHub에 새 기록이 있으면 이 PC로 가져옵니다.\n"
                "③ 「올리고 보내기」— 이 PC에서 남긴 기록을 GitHub로 보냅니다.\n"
                "   (받아오기·올리고 보내기를 눌렀을 때만 맞춰집니다.)\n"
                "\n"
                "알아 두기\n"
                "· 왼쪽의 상태 숫자로 「보낼 것 / 받을 것」을 볼 수 있습니다.\n"
                "· 「커밋 내역」은 지난 기록을 보는 창입니다.\n"
                "· 「충돌 취소」는 합치다가 겹쳤을 때 그 시도를 포기하는 비상 버튼입니다.\n"
                "· .env 같은 비밀 파일은 기본으로 올리지 않습니다.\n"
                "· 막히면 로그 아래 「다음:」 한 줄을 먼저 보세요.",
            ),
        ]
        ...
        if secrets or soft_content:
            ...
            if not allow_secrets:
                QMessageBox.warning(
                    ...
                    f"{listing}\n\n"
                    "폴더에 있어도 GitHub로 가는 기록에 아직 넣지 않았기 때문입니다.\n"
                    "(올리기 직전 대기 자리 — 설정 > 용어 안내의 「스테이징」)\n\n"
                    "1) 파일을 빼거나 이름 바꾸기\n"
